...
def page_user_management():
    ...
    with tab2:
        ...
        role = st.selectbox("Role", ["superadmin", "manager", "marketing"])
...
def get_all_marketing_activities():
    ...
    try:
        ...
        st.error(f"Error mengambil aktivitas: {e}")
        return []
...
def get_marketing_activities_by_user_id(user_id):
    ...
    try:
        ...
        st.error(f"Error mengambil aktivitas untuk pengguna: {e}")
        return []
...
def get_followups_by_activity_id(activity_id):
    ...
    try:
        ...
        st.error(f"Error mengambil follow-up: {e}")
        return []
...
def exchange_code_for_tokens(code):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return False, f"Error mendapatkan token: {response.text}"
    except Exception as e:
        return False, f"Error saat exchange code: {e}"
